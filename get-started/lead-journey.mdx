...
You do not have to remember any of the above. The Shipments screen keeps five cross-status counters
of what needs doing:

- **Needs quote** — new leads nobody has priced.
- **Needs contract** — orders with no agreement sent.
- **Awaiting payment** — signed but unpaid.
- **Posted, no offers** — live on the boards with nothing coming back.
- **Paid, not dispatched** — money in hand, no carrier yet.

<Warning>
  Never add these together. A single shipment can legitimately sit in more than one queue.
</Warning>
