...
Above the table you also get five cross-status counters — the "what needs me" view:
...
<Warning>
  Do not add these together. One shipment can sit in several queues at once — a to-do list, not a
  location.
</Warning>
