...
[Build your own quote form](/integrations/custom-quote-form) walks through a form that asks the
same pickup questions as the BeRocker widget — a pickup window or a timeframe — and hands the
customer straight to the booking page.
...
<CardGroup cols={2}>
  ...
  <Card title="Build your own quote form" icon="wand-magic-sparkles" href="/integrations/custom-quote-form">
    Your own form with pickup windows or timeframes.
  </Card>
