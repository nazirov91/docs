...
Super Dispatch returns one **open**-trailer price. The enclosed quote is derived by multiplying it
by this coefficient (between 0.1 and 10). There is a sample-price box so you can see what any
multiplier does before saving.
