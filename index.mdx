...
Here, you’ll find everything you need to **get started, configure your integrations, and manage your business** with BeRocker CRM.
...
- [Add RingCentral Phone Numbers](/integrations/phone/add-ring-central-phone-numbers)
- [Configure Twilio](integrations/phone/how-to-configure-twilio)
...
## Process flow of leads in BeRocker CRM

![process-flow](/images/process-flow.png)

[View PDF version](/documents/process-flow.pdf)
