---
title: "SendGrid — account and domain setup"
description: "Register a SendGrid account, authenticate your sending domain and generate the API key BeRocker needs."
---
...
<iframe
  ...
  title="How to Set Up Domain Authentication in SendGrid (Easily)"
  frameBorder='0'
...
<iframe
  className='w-full aspect-video rounded-xl'
  src='https://www.youtube.com/embed/Waty-a586hk'
  title="How to Set Up SendGrid API Key (Step By Step)"
  frameBorder='0'
  allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture'
  allowFullScreen
></iframe>
